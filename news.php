            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center">
                        <h1 class="font-weight-semibold mb-8 hero-2-title"><b>STED Insights<br> </b></h1>
                        <h2 class="font-weight-semibold mb-8 hero-2-title"><b>Stay Frosty with the Latest News and
                                Updates!</b></h2>
                        <p class="mb-5 text-muted subtitle w-75 mx-auto">STED Insights is your go-to platform for
                            breaking news, in-depth analysis,
                            and trending updates across technology, business, science, entertainment, and global events.
                            Stay informed with reliable,
                            engaging content that keeps you ahead of the curve.
                            Stay frosty with STED Insights as your guide to today’s fast-paced world.
                        </p>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-11 text-center">
                    ...
                    <p class="text-muted">Stay informed with the latest developments from the STED Incubation Forum!
                        Discover success stories,breakthrough innovations, upcoming events, and key highlights from our
                        dynamic community of entrepreneurs and industry experts.Follow our journey as we continue to
                        nurture ideas, empower startups, and drive innovation. Join us in celebrating milestones and
                        exploring opportunities to grow together.
            ...
            <section>
                <div class="row align-items-center section-work pb-o">
                    <div class="col-md-6">
                        <div class="position-relative mb-md-0 mb-5">
                            <div class="me-5 features-img">
                                <img src="images/dhule.jpeg"
                    ...
                    <div class="col-md-5 order-2 order-md-1 mt-md-0">
                        <h2 class="mb-4">Workshops to enhance entrepreneurial skills</h2>
                        <p class="text-muted mb-5">R.C.Patel parmaceutical Education and Research,DICCI Next Gen,state
                            incubation Forum by R.C.A two-day event called start up prerna was held at Patel College of
                            Pharmacy.</p>
                        <!--<a href="javascript: void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Find out more <i class="icon-xs ms-2" data-feather="arrow-right"></i></a>-->
                    </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">More About Our Solution</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <!-- Modal Body -->
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <img src="your-image-path.jpg" class="img-fluid" alt="Solution Image">
                                        </div>
                                        <div class="col-md-6">
                                            <h4>Our Solution for Small Businesses</h4>
                                            <p class="text-muted">
                                                Our service offers an ideal solution for small businesses. With features
                                                designed to streamline processes, enhance customer relationships, and
                                                improve overall business efficiency, we provide an all-in-one tool to
                                                help you grow and succeed. Whether you are a startup or an established
                                                business, our solution adapts to your needs.
                                            </p>
                                            <ul>
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-5 order-2 order-md-1 mt-md-0">
                            ...
                            <h2>The Students of Shirpur participated in the start-up competition.</h2>
                            <p>Appreciation:<br>Third Prize for Eco Friendly Sanitary Pads</p>
                            <!--<a href="javascript: void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Find out more <i class="icon-xs ms-2" data-feather="arrow-right"></i></a>-->
                        </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h4>Our Solution for Small Businesses</h4>
                                                <p class="text-muted">
                                                    Our service offers an ideal solution for small businesses. With
                                                    features designed to streamline processes, enhance customer
                                                    relationships, and improve overall business efficiency, we provide
                                                    an all-in-one tool to help you grow and succeed. Whether you are a
                                                    startup or an established business, our solution adapts to your
                                                    needs.
                                                </p>
                                                <ul>
                                                    <li>Cost-effective</li>
                    ...
                    <!--second-->
                    <div class="row align-items-center section-patel pb-o">
                        <div class="col-md-6">
                            <div class="position-relative mb-md-0 mb-">
                                <div class="me-5 features-img">
                                    <img src="images/pune%20nagari.jpeg"
                                        alt="" class="img-fluid d-block mx-auto rounded shadow" />
                                </div>
                                <img src="images/dot-img.png" alt="" class="dot-img-right" />
                            </div>
                        ...
                        <div class="col-md-5 order-2 order-md-1 mt-md-0 mt-5">
                            <h2 class="mb-4">Patel Pharmacy's 'Start up Prerna'</h2>
                            <p class="text-muted mb-5">Shirpur,February 03,2023: The Indian Center for Entrepreneurship
                                Development Successfully hosted its inagutal seminar on Startup and Entrepreneurship
                                Development at H.R.Patel institute of Pharmaceutical Education and Research Shirpur,
                                commemorating National Startup Day.</p>
                            <!--<a href="javascript: void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Find out more <i class="icon-xs ms-2" data-feather="arrow-right"></i></a>-->
                        </div>
            ...
            <!--second-->
            <div class="row align-items-center section-sted pb-o">
                <div class="col-md-6">
                    <div class="position-relative mb-md-0 mb-">
                        <div class="me-5 features-img">
                            <img src="images/news5.webp" style=" margin-left: 1000px;"
                                alt="" class="img-fluid d-block mx-auto rounded shadow" />
                        </div>
                        <img src="images/dot-img.png" alt="" class="dot-img-right" />
                    </div>
                ...
                <div class="col-md-5 order-2 order-md-1 mt-md-0 mt-5 section-sted1 ms-3">
    <h2 class="mb-4">STED Forms Strategic Alliance with H.R.Patel Pharmaceutical Institute</h2>
    <p class="text-muted mb-5">Shirpur, October 23, 2023: The Indian Center for Entrepreneurship Development (STED) is delighted to announce its recent memorandum of understanding.</p>
    <!--<a href="javascript: void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Find out more <i class="icon-xs ms-2" data-feather="arrow-right"></i></a>-->
</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="text-muted">
                                            Our service offers an ideal solution for small businesses. With features
                                            designed to streamline processes, enhance customer relationships, and
                                            improve overall business efficiency, we provide an all-in-one tool to help
                                            you grow and succeed. Whether you are a startup or an established business,
            ...
            <!--second-->
            <div class="row align-items-center section pb-o">
                <div class="col-md-6">
                    <div class="position-relative mb-md-0 mb-">
                        <div class="me-5 features-img">
                ...
                <div class="col-md-5 order-2 order-md-1 mt-md-0 mt-5">
                    <h2 class="mb-4">Shirpur's Entrepreneurial Spirit Ignites With STED's Event</h2>
                    <p class="text-muted mb-5">Shirpur,February 03,2023: The Indian Center for Entrepreneurship
                        Development Successfully hosted its inagutal seminar on Startup and Entrepreneurship Development
                        at H.R.Patel institute of Pharmaceutical Education and Research Shirpur,
                        commemorating National Startup Day.</p>
                    <!--<a href="javascript: void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Find out more <i class="icon-xs ms-2" data-feather="arrow-right"></i></a>-->
                </div>
